...
sides = st.sidebar.slider("Polygon / Star Sides", 3, 30, 6, 1)
petals = st.sidebar.slider("Flower Petals", 2, 30, 7, 1)
radius_min = st.sidebar.slider("Minimum Radius", 0.005, 0.2, 0.1, 0.001)
radius_max = st.sidebar.slider("Maximum Radius", 0.02, 0.4, 0.22, 0.001)
alpha_min = st.sidebar.slider("Minimum Alpha", 0.01, 0.6, 0.12, 0.01)
alpha_max = st.sidebar.slider("Maximum Alpha", 0.2, 1.0, 0.9, 0.01)
